...
class GameScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('blast', '../../image/spear.png');
        ...
        this.load.image('attack', '../../images/spear.png');
    ...
    create() {
        ...
        this.physics.add.collider(bullets,enemies,hits);
        this.physics.add.collider(bullets,boss,hitsboss);
